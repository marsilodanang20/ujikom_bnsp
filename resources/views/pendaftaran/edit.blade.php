...
@section('title', 'Edit Pendaftaran - Sistem Pendaftaran Kursus')
...
<div class="page-header animate-in">
    <div class="page-header-actions">
        <div>
            ...
            <p>Perbarui data pendaftaran #{{ $pendaftaran->id_daftar }}</p>
        </div>
        <a href="{{ route('pendaftaran.index') }}" class="btn btn-outline" id="back-pendaftaran-edit-btn">
...
<div class="form-card animate-in">
    <form action="{{ route('pendaftaran.update', $pendaftaran->id_daftar) }}" method="POST" id="pendaftaran-edit-form">
        @csrf
        @method('PUT')
        ...
        <div class="form-group">
            ...
            <input type="date" name="tgl_daftar" id="tgl_daftar" class="form-control" value="{{ old('tgl_daftar', $pendaftaran->tgl_daftar->format('Y-m-d')) }}">
        ...
        <div class="form-group">
            ...
            <select name="status" id="status" class="form-control">
                <option value="Aktif" {{ old('status', $pendaftaran->status) == 'Aktif' ? 'selected' : '' }}>Aktif</option>
        ...
        <div class="form-actions">
            <button type="submit" class="btn btn-primary" id="update-pendaftaran-btn">
